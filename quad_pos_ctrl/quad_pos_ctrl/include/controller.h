...
class Controller : public State_Estimate_Vio {
    public:
        ...
        nh_("~controller") {
            ...
            std::string lidar_topic_channel = parent_topic_name + std::to_string(rigid_id);
            lidar_topic_channel += "/distance_sensor/hrlv_ez4_pub";
            down_ward_lidar_sub = nh_.subscribe(lidar_topic_channel, 10, 
                                                &Controller::down_ward_lidar_cb, this);
        ...
        void down_ward_lidar_cb(const sensor_msgs::FluidPressure::Ptr msg);
